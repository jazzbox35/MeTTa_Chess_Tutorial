...
This repo hosts a Next.js frontend for a MeTTa-based chess/pattern-mining tutorial. The app proxies API calls through Next.js rewrites (see `frontend/next.config.mjs`) to the MeTTaWamJam Prolog MeTTa server PeTTa.
