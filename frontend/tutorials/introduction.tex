...
Reality is an incredibly complex phenomena. AI is a distinct discipline within computer science because worldly complex problems can't be handled by conventional programming in which all possible input combinations and desired outputs are accounted for in advance. AI evolved into a trick bag of techniques designed to reach a goal without specifically pre-coding all possible combinations. AI has to search for a path from start state to goal state by some means other than conventional programming.
