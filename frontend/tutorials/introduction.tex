...
Reality is an incredibly complex phenomena. AI is a distinct discipline within computer science because worldly complex problems can't be handled by conventional programming in which all possible combinations are accounted for in advance. Techniques were developed to reach goals without requiring the pre-coding of all sequences of all possible combinations. AI has to search for a path from start to goal state on its own. AI evolved into a trick bag for such situations. 
