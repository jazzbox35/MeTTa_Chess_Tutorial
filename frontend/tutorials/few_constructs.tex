...
Functions, also referred to as rewrite rules and equalities, have the distinct form of:

\textbf{(= (pattern) (result))}

The following example matches two variations of a light switch pattern. If called with the pattern of switch on, it returns the result off, and vice versa.
