...
few_constructs (or "interestingness") in the Hyperon Pattern Miner is implemented in \texttt{utils/MinerUtils.metta} by the I-few_constructs measure. It compares each pattern's empirical probability against an expected probability under a simple independence-based null model, then normalizes the largest deviation.
