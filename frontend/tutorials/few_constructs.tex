...
After you run the examples in this tutorial you can check your atomspace by clicking the button to display atomspace on top of each tutorial page. To tidy things up as you work through the examples click the button to reset atomspace. Refreshing your browser page will reset the examples and clear atomspace.
...
The basic format for removing atoms from atomspace is identical to "add-atom" except we use "remove-atom". The following example adds and then removes an atom. After you run the following code, check to see if "(my third atom)" is in atomspace. Then simply change "add-atom" to "remove-atom" in the code block to delete "(my third atom)" from atomspace. 
